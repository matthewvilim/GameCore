...
dword_t instr_calc_addr32_base_index(const cpu_t *cpu, const instr_t *instr;
dword_t instr_calc_addr32_base_offset(const cpu_t *cpu, const instr_t *instr);
dword_t instr_calc_addr32_index_offset(const cpu_t *cpu, const instr_t *instr);
dword_t instr_calc_addr32_base_index_offset(const cpu_t *cpu, const instr_t *instr);
